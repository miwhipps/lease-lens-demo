...
def test_vector_store():
    ...
    try:
        ...
        start_time = time.time()
        vector_store.add_document(sample_lease_text, "test_lease_001", {"filename": "test_lease.pdf", "source": "test"})
...
def test_rag_assistant(vector_store):
    ...
    try:
        ...
        batch_questions = ["What is the security deposit?", "Who handles maintenance?", "What are the termination rules?"]
