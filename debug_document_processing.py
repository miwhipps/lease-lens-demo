...
def debug_document_processing(file_path=None):
    ...
    if file_path and os.path.exists(file_path):
        ...
        if textract_available:
            ...
            # Mock processing
            result = {"text": test_content, "confidence": 95.0, "mock_extraction": True}
    ...
    test_queries = ["What is the monthly rent?", "How much is the rent?", "What is the rent amount?", "Tell me about rent"]
